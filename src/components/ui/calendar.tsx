  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption:
          'relative mx-10 mb-3 mt-1 flex h-7 items-center justify-center',
        ...
        range_middle:
          'rounded-none aria-selected:bg-accent aria-selected:text-accent-foreground hover:aria-selected:!bg-accent hover:aria-selected:text-accent-foreground hover:rounded-md',
